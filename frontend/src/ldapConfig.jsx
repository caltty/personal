...
function displaySuccess() {
    Modal.success({
        title: 'Success',
        content: 'Agron ldap configurations are setted successfully.',
    });
}
...
function displayError() {
    Modal.error({
        title: 'Error',
        content: 'Agron ldap configurations are fail to setted.',
    });
}
...
export default class LdapConfig extends React.Component {
    ...
    render() {
        const {url,bindUser,bindPassword,baseDn} = this.state;
        //this.getConfigurations();
        return (
            <Config>
                <h1>Agron Ldap Configuration</h1>
                <div className="form-horizontal">
                    <div className="form-group">
                        <label htmlFor="" className="control-label col-sm-2">Url:</label>
                        <div className="col-sm-4">
                            <Input placeholder="url" name="url"   value={url} onChange={this.onChange} />
                        </div>
                    </div>
                    <div className="form-group">
                        <label htmlFor="" className="control-label col-sm-2">Bind user:</label>
                        <div className="col-sm-4">
                            <Input placeholder="bind user" name="bind user"   value={bindUser} onChange={this.onChange} />
                        </div>
                    </div>
                    <div className="form-group">
                        <label htmlFor="" className="control-label col-sm-2">Bind password:</label>
                        <div className="col-sm-4">
                            <Input placeholder="bind password" name="bind password"   value={bindPassword} onChange={this.onChange} />
                        </div>
                    </div>
                    <div className="form-group">
                        <label htmlFor="" className="control-label col-sm-2">Base dn:</label>
                        <div className="col-sm-4">
                            <Input placeholder="base dn" name="base dn"   value={baseDn} onChange={this.onChange} />
                        </div>
                    </div>
                    <div className="form-group">
